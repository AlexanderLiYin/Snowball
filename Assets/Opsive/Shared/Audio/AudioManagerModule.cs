...
namespace Opsive.Shared.Audio
{
    ...
    public class AudioManagerModule : ScriptableObject
    {
        ...
        {
            var audioSourceInfo = PlayAudio(gameObject, audioClipInfo);
            audioSourceInfo.AudioSource.transform.position = position;
        ...
        public AudioSource Stop(GameObject gameObject, AudioConfig audioConfig)
        {
        ...
        /// <returns>The AudioSource that was stopped playing (can be null).</returns>
        public AudioSource Stop(GameObject gameObject, PlayResult playResult)
        {
